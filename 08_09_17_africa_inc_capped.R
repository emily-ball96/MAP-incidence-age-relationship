...
alpha <- 0.1
beta <- 0.1
c1 <- qgamma(0.025, africa_data$INC + alpha, africa_data$PYO + beta)
c2 <- qgamma(0.975, africa_data$INC + alpha, africa_data$PYO + beta)
##arrows(africa_data$AGE, africa_data$INC - c1, africa_data$AGE, africa_data$INC + c2, length = 0.01, angle = 90, code = 3)
